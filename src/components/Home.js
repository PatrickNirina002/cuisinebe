...
export default class Home extends Component {
    ...
    componentDidMount() {
        axios.get('http://naivobetsy.herokuapp.com/affichertous')
            .then(response => {
...
<div class="card-body">
  ...
  <div className="container"><img width="90%" height="300px" src={'http://naivobetsy.herokuapp.com/user/'+obj.image} alt="pdp" /></div>
